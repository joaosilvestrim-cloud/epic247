  ...
  return {
    ...
    secoes: [
      ...
      },
      {
        ...
        paragrafos: [
          "Este relatório é o ponto de partida. O Módulo Energia te dá o sistema completo, Manual, Workbook e o Livro Energia, para transformar estes passos em resultado real.",
