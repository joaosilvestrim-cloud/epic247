...
export default function AdminDashboard({
  ...
  return (
    <main className="min-h-screen bg-offwhite px-6 py-10 text-navy">
      <div className="mx-auto max-w-6xl">
        ...
        <header className="flex flex-wrap items-center justify-between gap-4">
          <div>
            ...
            <p className="text-sm text-navy/60">
              Respostas do quiz e gestão de conteúdo
            </p>
          </div>
        ...
        <div className="mt-8 grid gap-4 sm:grid-cols-3">
          ...
          <div className="rounded-2xl border border-line/40 bg-white p-6 sm:col-span-2">
            <p className="mb-3 text-sm text-navy/60">Distribuição por Dreno Dominante</p>
            <div className="space-y-2">
              {distribuicao.map((d) => (
                <div key={d.id} className="flex items-center gap-3">
                  ...
                  <span className="w-8 text-right text-sm font-semibold">{d.qtd}</span>
                </div>
              ))}
            </div>
          </div>
