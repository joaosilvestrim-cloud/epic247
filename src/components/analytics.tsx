...
/**
 * Injeta as tags de rastreamento configuradas na aba Marketing do /admin.
 * Cada bloco só entra no HTML se o ID correspondente estiver preenchido.
 *
 * O Google Tag Manager é o coringa: com ele ligado, o time de marketing
 * cadastra qualquer outra tag pelo painel do GTM, sem tocar no código.
 */
...
fbq('init','${metaPixelId}');fbq('track','PageView');`}
      ...
      {/* GA4 e Google Ads dividem o mesmo gtag.js */}
      {(ga4Id || googleAdsId) && (
        <>
          <Script
